...
**Context:** feasibility v0.2 §3（HTTP 取得設計）および PRD v0.2 F-01〜F-07、NFR-01〜NFR-05 の実装核。v0.1 の `feedparser` ベースフェッチャーを完全破棄し、`requests` + `beautifulsoup4` で書き直す。
